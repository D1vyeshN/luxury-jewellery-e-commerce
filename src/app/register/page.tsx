      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          <div className="relative aspect-[4/5] overflow-hidden">
            <img
              src="https://images.pexels.com/photos/17068457/pexels-photo-17068457.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=800&w=600"
            ...
            <div className="absolute bottom-0 left-0 right-0 p-8">
              ...
              <p className="text-white/80 text-sm font-sans leading-relaxed">
                Create an account to unlock exclusive offers, track your orders, and save your favorite pieces.
              </p>
            </div>
          </div>
        </motion.div>
